import { Stack, styled, Switch, Typography, FormGroup, FormControlLabel } from "@mui/material";
  ...
  "& .MuiSwitch-switchBase": {
    ...
    "&.Mui-checked": {
      ...
      "& .MuiSwitch-thumb:before": {
        backgroundImage: `url('data:image/svg+xml;utf8,<svg xmlns="https://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 20 20"><path fill="${encodeURIComponent(
          "#fff"
